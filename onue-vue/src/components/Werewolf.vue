...
export default {
    data(){
        return{
            onuwRoles: [{name: "Doppleganger", wakeOrder: 1}, {name: "Werewolf", wakeOrder: 2}, {name: "Werewolf", wakeOrder: 2}, {name: "Minion", wakeOrder: 3},
    ...
    addRoleToPlay() {
        let rolesInPlay = [{}]
        document.getElementsByClassName('role').onclick = ()=>{rolesInPlay.push(role.textContent)
